...
export default function SectionSatu ({hero}) {
    ...
    return (
        <div className="section-satu pt-30 px-8 min-[1920px]:mr-20 py-10 flex flex-col lg:flex-row-reverse lg:justify-around min-[1920px]:justify-between lg:items-center lg:px-12 gap-8 bg-cyan-0">
            <div className="hero">
                <img src={hero} alt="" className="drop-shadow-2xl min-[1920px]:-translate-x-10 lg:scale-100 min-[1920px]:scale-145" />
            </div>

            <div className="konten lg:max-w-[400px] 2xl:max-w-[700px] min-[1920px]:mr-80  xl:translate-x-11 2xl:translate-x-10 min-[1920px]:-translate-x-10">
